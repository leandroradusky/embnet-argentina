/* $RCSfile$
 * $Author: aherraez $
 * $Date: 2011-07-04 18:26:05 +0200 (lun., 04 juil. 2011) $
 * $Revision: 15717 $
...
final public class JmolConstants {
  ...
  public final static String cvsDate = "$Date: 2011-07-04 18:26:05 +0200 (lun., 04 juil. 2011) $"; //
...
cpk on; select atomno>100; label %i; color chain; select selected & hetero; cpk off
  ...
  */
  ...
  private final static String allCarbohydrates = 
    ...
    ",[AFL],[AGC],[GLB],[NAN],[RAA]"; //these 5 are deprecated in PDB
