...
//final static int boundbox     see mathproperty
  ...
  public final static int label  = 3 /*must be odd*/ | 0 << 9 | mathfunc | mathproperty | strproperty | settable | implicitStringCommand | shapeCommand | defaultON | deprecatedparam;
