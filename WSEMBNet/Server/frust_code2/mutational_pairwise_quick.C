...
Array<float,2> native_surface_energy_fold(native_contact_cnt,(surf_decoys+1));
native_surface_energy_fold=0;
Array<float,2> native_surface_energy_fold_burial(native_contact_cnt,(surf_decoys+1));
native_surface_energy_fold_burial=0;
...
for (res_it_3 = S.beginResidue(); res_it_3 != S.endResidue(); ++res_it_3) {
	...
	for (res_it_4 = res_it_3; res_it_4 != S.endResidue(); ++res_it_4) {
		if (native_contact_map(res_1_position,res_2_position)>0) {
			if (res_1_position < (res_2_position-1)) {
				//get native burial
				native_surface_energy_fold_burial(contact_cnt3,surf_decoys) += ((gammas3_1[seg_res[res_1_position]]*S1_native(res_1_position)+gammas3_2[seg_res[res_1_position]]*S2_native(res_1_position)+gammas3_3[seg_res[res_1_position]]*S3_native(res_1_position)));
				native_surface_energy_fold_burial(contact_cnt3,surf_decoys) += ((gammas3_1[seg_res[res_2_position]]*S1_native(res_2_position)+gammas3_2[seg_res[res_2_position]]*S2_native(res_2_position)+gammas3_3[seg_res[res_2_position]]*S3_native(res_2_position)));
				...
				native_surface_energy_fold(contact_cnt3,surf_decoys) += ( 0.25 * (1+tanh(7*(rij_-well_1_start))) * (1+tanh(7*(well_1_end-rij_))) * gammas1_well_1_f[seg_res[res_1_position]][seg_res[res_2_position]] );
				...
				native_surface_energy_fold(contact_cnt3,surf_decoys) += ( 0.25 * (1+tanh(5*(rij_-well_2_start))) * (1+tanh(5*(well_2_end-rij_))) * (water_fraction*gammas2_well_2_f[seg_res[res_1_position]][seg_res[res_2_position]] + buried_fraction*gammas1_well_2_f[seg_res[res_1_position]][seg_res[res_2_position]] ) );
				for (r_1 = 0; r_1 < native_chain_length; r_1++) {
					for (r_2 = (r_1+2); r_2 < native_chain_length; r_2++) {
						if (native_contact_map(r_1,r_2)>0) {
							if ( (r_1==res_2_position) || ((r_1==res_1_position)&&(r_2!=res_2_position)) || ((r_1!=res_1_position)&&(r_2==res_2_position)) || (r_2==res_1_position) ) {
								//DIRECT (well1)
								native_surface_energy_fold(res1_res2_to_cont(r_1,r_2),surf_decoys) += ( 0.25 * (1+tanh(7*(rij_-well_1_start))) * (1+tanh(7*(well_1_end-rij_))) * gammas1_well_1_f[seg_res[res_1_position]][seg_res[res_2_position]] );
								//DIRECT and WATER (well2)
								native_surface_energy_fold(res1_res2_to_cont(r_1,r_2),surf_decoys) += ( 0.25 * (1+tanh(5*(rij_-well_2_start))) * (1+tanh(5*(well_2_end-rij_))) * (water_fraction*gammas2_well_2_f[seg_res[res_1_position]][seg_res[res_2_position]] + buried_fraction*gammas1_well_2_f[seg_res[res_1_position]][seg_res[res_2_position]] ) );
							}
						}
					}
				}
				...
				for (restype1=0;restype1<surf_decoys;restype1+=1) {
					...
					native_surface_energy_fold_burial(contact_cnt3,restype1) += ((gammas3_1[rand_res_paira(contact_cnt3,restype1)]*S1_native(res_1_position)+gammas3_2[rand_res_paira(contact_cnt3,restype1)]*S2_native(res_1_position)+gammas3_3[rand_res_paira(contact_cnt3,restype1)]*S3_native(res_1_position)));
					native_surface_energy_fold_burial(contact_cnt3,restype1) += ((gammas3_1[rand_res_pairb(contact_cnt3,restype1)]*S1_native(res_2_position)+gammas3_2[rand_res_pairb(contact_cnt3,restype1)]*S2_native(res_2_position)+gammas3_3[rand_res_pairb(contact_cnt3,restype1)]*S3_native(res_2_position)));
					...
					//	contact
					native_surface_energy_fold(contact_cnt3,restype1) += ( 0.25 * (1+tanh(7*(rij_-well_1_start))) * (1+tanh(7*(well_1_end-rij_))) * gammas1_well_1_f[rand_res_paira(contact_cnt3,restype1)][rand_res_pairb(contact_cnt3,restype1)] );
					//get decoy energies for contact - DIRECT and WATER (well2)
					//	contact
					native_surface_energy_fold(contact_cnt3,restype1) += ( 0.25 * (1+tanh(5*(rij_-well_2_start))) * (1+tanh(5*(well_2_end-rij_))) * (water_fraction*gammas2_well_2_f[rand_res_paira(contact_cnt3,restype1)][rand_res_pairb(contact_cnt3,restype1)] + buried_fraction*gammas1_well_2_f[rand_res_paira(contact_cnt3,restype1)][rand_res_pairb(contact_cnt3,restype1)] ) );

					for (r_1 = 0; r_1 < native_chain_length; r_1++) {
						for (r_2 = (r_1+2); r_2 < native_chain_length; r_2++) {
							if (native_contact_map(r_1,r_2)>0) {
								if (r_1==res_2_position) {
									//	contact - DIRECT (well1)
									native_surface_energy_fold(res1_res2_to_cont(r_1,r_2),restype1) += ( 0.25 * (1+tanh(7*(rij_-well_1_start))) * (1+tanh(7*(well_1_end-rij_))) * gammas1_well_1_f[seg_res[res_1_position]][rand_res_paira(res1_res2_to_cont(r_1,r_2),restype1)] );
									//	contact - DIRECT and WATER (well2)
									native_surface_energy_fold(res1_res2_to_cont(r_1,r_2),restype1) += ( 0.25 * (1+tanh(5*(rij_-well_2_start))) * (1+tanh(5*(well_2_end-rij_))) * (water_fraction*gammas2_well_2_f[seg_res[res_1_position]][rand_res_paira(res1_res2_to_cont(r_1,r_2),restype1)] + buried_fraction*gammas1_well_2_f[seg_res[res_1_position]][rand_res_paira(res1_res2_to_cont(r_1,r_2),restype1)] ) );
								}
								if ((r_1==res_1_position)&&(r_2!=res_2_position)) {
									//	contact - DIRECT (well1)
									native_surface_energy_fold(res1_res2_to_cont(r_1,r_2),restype1) += ( 0.25 * (1+tanh(7*(rij_-well_1_start))) * (1+tanh(7*(well_1_end-rij_))) * gammas1_well_1_f[rand_res_paira(res1_res2_to_cont(r_1,r_2),restype1)][seg_res[res_2_position]] );
									//	contact - DIRECT and WATER (well2)
									native_surface_energy_fold(res1_res2_to_cont(r_1,r_2),restype1) += ( 0.25 * (1+tanh(5*(rij_-well_2_start))) * (1+tanh(5*(well_2_end-rij_))) * (water_fraction*gammas2_well_2_f[rand_res_paira(res1_res2_to_cont(r_1,r_2),restype1)][seg_res[res_2_position]] + buried_fraction*gammas1_well_2_f[rand_res_paira(res1_res2_to_cont(r_1,r_2),restype1)][seg_res[res_2_position]] ) );
								}
								if ((r_1!=res_1_position)&&(r_2==res_2_position)) {
									//	contact - DIRECT (well1)
									native_surface_energy_fold(res1_res2_to_cont(r_1,r_2),restype1) += ( 0.25 * (1+tanh(7*(rij_-well_1_start))) * (1+tanh(7*(well_1_end-rij_))) * gammas1_well_1_f[seg_res[res_1_position]][rand_res_pairb(res1_res2_to_cont(r_1,r_2),restype1)] );
									//	contact - DIRECT and WATER (well2)
									native_surface_energy_fold(res1_res2_to_cont(r_1,r_2),restype1) += ( 0.25 * (1+tanh(5*(rij_-well_2_start))) * (1+tanh(5*(well_2_end-rij_))) * (water_fraction*gammas2_well_2_f[seg_res[res_1_position]][rand_res_pairb(res1_res2_to_cont(r_1,r_2),restype1)] + buried_fraction*gammas1_well_2_f[seg_res[res_1_position]][rand_res_pairb(res1_res2_to_cont(r_1,r_2),restype1)] ) );
								}
								if (r_2==res_1_position) {
									//	contact - DIRECT (well1)
									native_surface_energy_fold(res1_res2_to_cont(r_1,r_2),restype1) += ( 0.25 * (1+tanh(7*(rij_-well_1_start))) * (1+tanh(7*(well_1_end-rij_))) * gammas1_well_1_f[rand_res_pairb(res1_res2_to_cont(r_1,r_2),restype1)][seg_res[res_2_position]] );
									//	contact - DIRECT and WATER (well2)
									native_surface_energy_fold(res1_res2_to_cont(r_1,r_2),restype1) += ( 0.25 * (1+tanh(5*(rij_-well_2_start))) * (1+tanh(5*(well_2_end-rij_))) * (water_fraction*gammas2_well_2_f[rand_res_pairb(res1_res2_to_cont(r_1,r_2),restype1)][seg_res[res_2_position]] + buried_fraction*gammas1_well_2_f[rand_res_pairb(res1_res2_to_cont(r_1,r_2),restype1)][seg_res[res_2_position]] ) );
								}
							}
						}
					}
...
//contact-only arrays:
Array<double,1> native_surface_energy_fold_res_only_temp(surf_decoys);
//burial-only arrays:
Array<double,1> native_surface_energy_fold_burial_res_only_temp(surf_decoys);
//contact and burial array:
Array<double,1> native_surface_energy_fold_both_res_only_temp(surf_decoys);

	for (q=0;q<native_chain_length;q+=1) {
		for (q2=(q+2);q2<native_chain_length;q2+=1) {
			//report contact info
			if (native_contact_map(q,q2)>0) {
				native_surface_energy_fold_res_only_temp=0; 
				native_surface_energy_fold_burial_res_only_temp=0; 
				native_surface_energy_fold_both_res_only_temp=0; 
				int rr=0;
				for (restype1=0;restype1<surf_decoys;restype1+=1) {
					//contact-only
					native_surface_energy_fold_res_only_temp(rr) = native_surface_energy_fold(res1_res2_to_cont(q,q2),restype1);
					//burial-only
					native_surface_energy_fold_burial_res_only_temp(rr) = native_surface_energy_fold_burial(res1_res2_to_cont(q,q2),restype1);
					//contact and burial
					native_surface_energy_fold_both_res_only_temp(rr) = (native_surface_energy_fold(res1_res2_to_cont(q,q2),restype1) + native_surface_energy_fold_burial_res_only_temp(rr));

					rr++;
				} // restype1 loop

				//contact only
				decoy_mean_fold = gsl_stats_mean(native_surface_energy_fold_res_only_temp.data(),1,surf_decoys);
				decoy_std_fold = gsl_stats_sd(native_surface_energy_fold_res_only_temp.data(),1,surf_decoys);
				cout << "CONT\t" << q << "\t" << q2 << "\t" << native_surface_energy_fold(res1_res2_to_cont(q,q2),surf_decoys) << "\t" << decoy_mean_fold << "\t" << ((native_surface_energy_fold(res1_res2_to_cont(q,q2),surf_decoys)-decoy_mean_fold)/decoy_std_fold) << endl;

				//burial only - both residues coupled
				double native_burial = native_surface_energy_fold_burial(res1_res2_to_cont(q,q2),surf_decoys);
				decoy_mean_fold = gsl_stats_mean(native_surface_energy_fold_burial_res_only_temp.data(),1,surf_decoys);
				decoy_std_fold = gsl_stats_sd(native_surface_energy_fold_burial_res_only_temp.data(),1,surf_decoys);
				cout << "CONT_BURIAL\t" << q << "\t" << q2 << "\t" << native_burial << "\t" << decoy_mean_fold << "\t" << ((native_burial-decoy_mean_fold)/decoy_std_fold) << endl;

				//contact and burial (both)
				double native_both = (native_surface_energy_fold(res1_res2_to_cont(q,q2),surf_decoys)+native_surface_energy_fold_burial(res1_res2_to_cont(q,q2),surf_decoys));
				decoy_mean_fold = gsl_stats_mean(native_surface_energy_fold_both_res_only_temp.data(),1,surf_decoys);
				decoy_std_fold = gsl_stats_sd(native_surface_energy_fold_both_res_only_temp.data(),1,surf_decoys);
/* this is how mjenik received the output line ----
				cout << "CONT_BOTH\t" << q << "\t" << q2 << "\t" << native_both << "\t" << decoy_mean_fold << "\t" << ((native_both-decoy_mean_fold)/decoy_std_fold) << endl;
*/

/* this is config quick CONT_BOTH output line -----
...
*/
/*this is how mjenik modified the line by adding contact type at the last column */
				cout << "CONT_BOTH\t" << q << "\t" << q2 << "\t" << native_both << "\t" << decoy_mean_fold << "\t" << ((native_both-decoy_mean_fold)/decoy_std_fold) << "\t" << cont_to_type[res1_res2_to_cont(q,q2)] << endl;



			} // if (native_contact_count.. > 0)
		} // q2 loop
	} // q loop
